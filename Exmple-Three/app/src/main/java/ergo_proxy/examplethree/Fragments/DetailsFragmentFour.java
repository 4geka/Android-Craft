 ...
 */
public class DetailsFragmentFour  extends Fragment implements View.OnClickListener
{
    ...
    public static DetailsFragmentFour newInstance(String param1, String param2)
    {
        DetailsFragmentFour fragment = new DetailsFragmentFour();
    ...
    {
        LinearLayout inflateView = (LinearLayout) inflater.inflate(R.layout.activity_details4, container, false);
